...
const PopularCat = () => {
  return (
    <div className="w-full h-auto flex flex-col my-4 py-10">
        <h1 className="text-4xl font-bold text-left">Popular Categories</h1>
        <div className="w-full h-auto flex flex-wrap my-4 py-8">
            {Categories.map((category) => (
                <div key={category.id} className="flex justify-center rounded-2xl bg-slate-500 mx-6 px-6 py-3 hover:bg-slate-600">
